...
Prosumer.create([ {name: "Prosumer 1", cluster: clusters.first, intelen_id: 1, building_type: domestic, connection_type: adsl, location_x: 35.508545, location_y: 24.016015},
                  {name: "Prosumer 2", cluster: clusters.first, intelen_id: 2, building_type: school, connection_type: adsl, location_x: 37.834419, location_y: 23.796322},
                  {name: "Prosumer 3", cluster: clusters.first, intelen_id: 3, building_type: school, connection_type: adsl, location_x: 37.983715, location_y: 23.729309},
                  {name: "Prosumer 4", cluster: clusters.first, intelen_id: 4, building_type: school, connection_type: adsl, location_x: 38.029222, location_y: 23.801853},
                  {name: "Prosumer 5", cluster: clusters.first, intelen_id: 5, building_type: school, connection_type: adsl, location_x: 38.018877, location_y: 23.789665},
                  {name: "Prosumer 6", cluster: clusters.first, intelen_id: 6, building_type: school, connection_type: adsl, location_x: 38.009410, location_y: 23.776104},
                  {name: "Prosumer 7", cluster: clusters.first, intelen_id: 7, building_type: school, connection_type: adsl, location_x: 38.035644, location_y: 23.834726},
                  {name: "Prosumer 8", cluster: clusters.first, intelen_id: 8, building_type: school, connection_type: adsl, location_x: 38.036929, location_y: 23.738167},
                  {name: "Prosumer 9", cluster: clusters.first, intelen_id: 9, building_type: school, connection_type: adsl, location_x: 38.044635, location_y: 23.769152},
