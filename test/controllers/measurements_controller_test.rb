...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { power: @measurement.power, prosumer_id: @measurement.prosumer_id, timeslot: @measurement.timeslot }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { power: @measurement.power, prosumer_id: @measurement.prosumer_id, timeslot: @measurement.timeslot }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
